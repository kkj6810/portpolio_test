						...
						<div class="form-group">
							<div class="checkbox col-lg-3 pull-left">
							 	<label class="pull-right">
		                        	...
		                        	<s:message code="project.prtitle"/>
		                        </label>
							 	<label class="pull-right">
							 		<input type="checkbox" name="searchType" value="prstatus" <c:if test="${fn:indexOf(searchVO.searchType, 'prstatus')!=-1}">checked="checked"</c:if>/>
		                        	<s:message code="project.prstatus"/>
		                        </label>
		                   </div>
